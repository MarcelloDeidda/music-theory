import { numberToString, semitonesToIntervalsInterface, stringToString } from "../../ts/interfaces/interfaces"

export const qualities: stringToString = {
    augmented: "augmented",
...
export const intervalNumbers: numberToString = {
    1: "unison",
    2: "second",
    3: "third",
    4: "fourth",
...
export const semitonesToIntervals: semitonesToIntervalsInterface = {
    0: {
